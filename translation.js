...
const UI_TEXTS = {
    ...
    eng: {
        ...
        backButton: "Back",
        nextButton: "Next",
        actionPlanButton: "AI Action Plan",
    ...
    can: {
        mainTitle: "ASK ANYTHING",
        mainSubtitle: "點擊卡片開始",
        questionDialogTitle: "您想如何提出問題？",
        directInput: "直接輸入",
        fortuneSelect: "運勢選擇",
        mindQuestion: "在心中提問",
        customQuestionTitle: "請直接輸入您的問題",
        questionPlaceholder: "例如：我能在新工作中成功嗎？",
        backButton: "返回",
        nextButton: "下一步",
        actionPlanButton: "AI現實建議",
        mbtiInputTitle: "您的MBTI是什麼？",
        mbtiInputDesc: "這將在您的結果中提供更準確的建議。",
        mbtiPlaceholder: "例如：INFP, ENFJ",
        skipButton: "跳過",
        mbtiUnknownButton: "不知道您的MBTI？進行測試",
        mbtiResultTitle: "您的'陰陽MBTI'是...",
        mbtiResultDesc: "大寫字母表示強烈傾向，小寫字母表示弱傾向。您的塔羅解讀將基於此進行。",
        answerScale: { 
            agree_strong: "完全同意", 
            agree: "大致同意", 
            neutral: "中性 / 不知道", 
            disagree: "大致不同意", 
            disagree_strong: "完全不同意" 
        },
        selectCards: "選擇4張卡片。",
        interpreting: "正在解讀...",
        individualCardsTitle: "個別卡片解讀",
        prevButton: "上一個",
        pdfSaveButton: "保存為PDF",
        restartButton: "重新開始",
        shuffleStatus: {
            playing: "正在洗牌...",
            completed: "洗牌完成！"
        ...
        loadingLoopText: "正在召喚您的命運...",
        cardStageTitleTemplate: "第{num}張卡片解讀",
        cardTouchHint: "觸摸卡片",
        keywordPositive: "正面",
        keywordCaution: "注意",
        actionPlanButtonLabel: "現實建議"
    },
    vi: {
        mainTitle: "ASK ANYTHING",
        mainSubtitle: "Nhấp vào thẻ để bắt đầu",
        questionDialogTitle: "Bạn muốn đặt câu hỏi như thế nào?",
        directInput: "Nhập trực tiếp",
        fortuneSelect: "Chọn vận mệnh",
        mindQuestion: "Hỏi trong tâm trí",
        customQuestionTitle: "Vui lòng nhập câu hỏi của bạn trực tiếp",
        questionPlaceholder: "Ví dụ: Tôi có thể thành công trong công việc mới không?",
        backButton: "Quay lại",
        nextButton: "Tiếp theo",
        actionPlanButton: "Kế hoạch AI",
        mbtiInputTitle: "MBTI của bạn là gì?",
        mbtiInputDesc: "Điều này cung cấp lời khuyên chính xác hơn trong kết quả của bạn.",
        mbtiPlaceholder: "Ví dụ: INFP, ENFJ",
        skipButton: "Bỏ qua",
        mbtiUnknownButton: "Không biết MBTI của bạn? Làm bài kiểm tra",
        mbtiResultTitle: "MBTI 'Âm Dương' của bạn là...",
        mbtiResultDesc: "Chữ hoa có nghĩa là xu hướng mạnh, chữ thường có nghĩa là xu hướng yếu. Việc đọc tarot của bạn sẽ dựa trên điều này.",
        answerScale: { 
            agree_strong: "Hoàn toàn đồng ý", 
            agree: "Khá đồng ý", 
            neutral: "Trung tính / Không biết", 
            disagree: "Khá không đồng ý", 
            disagree_strong: "Hoàn toàn không đồng ý" 
        },
        selectCards: "Chọn 4 thẻ.",
        interpreting: "Đang giải thích...",
        individualCardsTitle: "Giải thích thẻ riêng lẻ",
        prevButton: "Trước",
        pdfSaveButton: "Lưu dưới dạng PDF",
        restartButton: "Bắt đầu lại",
        shuffleStatus: {
            playing: "Đang xáo trộn thẻ...",
            completed: "Xáo trộn hoàn tất!"
        },
        fortuneOptions: {
            general: "Vận mệnh tổng thể",
            love: "Vận tình duyên",
            business: "Vận kinh doanh",
            marriage: "Vận hôn nhân",
            children: "Vận con cái",
            career: "Vận sự nghiệp",
            money: "Vận tài lộc",
            health: "Vận sức khỏe",
            relationships: "Vận quan hệ"
        },
        loadingLoopText: "Đang gọi vận mệnh của bạn...",
        cardStageTitleTemplate: "Thẻ thứ {num}",
        cardTouchHint: "Chạm vào thẻ",
        keywordPositive: "Tích cực",
        keywordCaution: "Cẩn thận",
        actionPlanButtonLabel: "Lời khuyên thực tế"
    },
    id: {
        mainTitle: "ASK ANYTHING",
        mainSubtitle: "Klik kartu untuk memulai",
        questionDialogTitle: "Bagaimana Anda ingin mengajukan pertanyaan?",
        directInput: "Input Langsung",
        fortuneSelect: "Pilih Ramalan",
        mindQuestion: "Tanya dalam Pikiran",
        customQuestionTitle: "Silakan masukkan pertanyaan Anda langsung",
        questionPlaceholder: "Contoh: Apakah saya bisa sukses di pekerjaan baru?",
        backButton: "Kembali",
        nextButton: "Selanjutnya",
        actionPlanButton: "Rencana AI",
        mbtiInputTitle: "Apa MBTI Anda?",
        mbtiInputDesc: "Ini memberikan saran yang lebih akurat dalam hasil Anda.",
        mbtiPlaceholder: "Contoh: INFP, ENFJ",
        skipButton: "Lewati",
        mbtiUnknownButton: "Tidak tahu MBTI Anda? Ikuti tes",
        mbtiResultTitle: "MBTI 'Yin-Yang' Anda adalah...",
        mbtiResultDesc: "Huruf kapital berarti kecenderungan kuat, huruf kecil berarti kecenderungan lemah. Pembacaan tarot Anda akan didasarkan pada ini.",
        answerScale: { 
            agree_strong: "Sangat Setuju", 
            agree: "Cukup Setuju", 
            neutral: "Netral / Tidak Tahu", 
            disagree: "Cukup Tidak Setuju", 
            disagree_strong: "Sangat Tidak Setuju" 
        },
        selectCards: "Pilih 4 kartu.",
        interpreting: "Sedang menafsirkan...",
        individualCardsTitle: "Interpretasi Kartu Individual",
        prevButton: "Sebelumnya",
        pdfSaveButton: "Simpan sebagai PDF",
        restartButton: "Mulai Ulang",
        shuffleStatus: {
            playing: "Mengocok kartu...",
            completed: "Pengocokan selesai!"
        },
        fortuneOptions: {
            general: "Ramalan Umum",
            love: "Ramalan Cinta",
            business: "Ramalan Bisnis",
            marriage: "Ramalan Pernikahan",
            children: "Ramalan Anak",
            career: "Ramalan Karir",
            money: "Ramalan Uang",
            health: "Ramalan Kesehatan",
            relationships: "Ramalan Hubungan"
        },
        loadingLoopText: "Memanggil takdir Anda...",
        cardStageTitleTemplate: "Kartu ke-{num}",
        cardTouchHint: "Sentuh kartu",
        keywordPositive: "Positif",
        keywordCaution: "Hati-hati",
        actionPlanButtonLabel: "Nasihat Realistis"
    },
    chn: {
        mainTitle: "ASK ANYTHING",
        mainSubtitle: "点击卡片开始",
        ...
        questionPlaceholder: "例如：我能在新工作中成功吗？",
        backButton: "返回",
        nextButton: "下一步",
        actionPlanButton: "AI现实建议",
        mbtiInputTitle: "您的MBTI是什么？",
        mbtiInputDesc: "这将在您的结果中提供更准确的建议。",
        mbtiPlaceholder: "例如：INFP, ENFJ",
        skipButton: "跳过",
        mbtiUnknownButton: "不知道您的MBTI？进行测试",
        mbtiResultTitle: "您的'阴阳MBTI'是...",
        mbtiResultDesc: "大写字母表示强烈倾向，小写字母表示弱倾向。您的塔罗解读将基于此进行。",
        answerScale: { 
            agree_strong: "完全同意", 
            agree: "大致同意", 
            neutral: "中性 / 不知道", 
        ...
        loadingLoopText: "正在召唤您的命运...",
        cardStageTitleTemplate: "第{num}张卡片解读",
        cardTouchHint: "触摸卡片",
        keywordPositive: "正面",
        keywordCaution: "注意",
        actionPlanButtonLabel: "现实建议"
    },
    fr: {
        mainTitle: "ASK ANYTHING",
        mainSubtitle: "Cliquez sur la carte pour commencer",
        questionDialogTitle: "Comment voulez-vous poser votre question ?",
        directInput: "Saisie directe",
        fortuneSelect: "Sélection de fortune",
        mindQuestion: "Demander dans l'esprit",
        customQuestionTitle: "Veuillez saisir votre question directement",
        questionPlaceholder: "Ex: Puis-je réussir dans mon nouvel emploi ?",
        backButton: "Retour",
        nextButton: "Suivant",
        actionPlanButton: "Plan d'action IA",
        mbtiInputTitle: "Quel est votre MBTI ?",
        mbtiInputDesc: "Cela fournit des conseils plus précis dans vos résultats.",
        mbtiPlaceholder: "Ex: INFP, ENFJ",
        skipButton: "Passer",
        mbtiUnknownButton: "Vous ne connaissez pas votre MBTI ? Faites le test",
        mbtiResultTitle: "Votre MBTI 'Yin-Yang' est...",
        mbtiResultDesc: "Une lettre majuscule signifie une tendance forte, une lettre minuscule signifie une tendance faible. Votre lecture tarot sera basée sur cela.",
        answerScale: { 
            agree_strong: "Tout à fait d'accord", 
            agree: "Plutôt d'accord", 
            neutral: "Neutre / Je ne sais pas", 
            disagree: "Plutôt pas d'accord", 
            disagree_strong: "Tout à fait pas d'accord" 
        },
        selectCards: "Sélectionnez 4 cartes.",
        interpreting: "Interprétation en cours...",
        individualCardsTitle: "Interprétations de cartes individuelles",
        prevButton: "Précédent",
        pdfSaveButton: "Enregistrer en PDF",
        restartButton: "Recommencer",
        shuffleStatus: {
            playing: "Mélange des cartes...",
            completed: "Mélange terminé !"
        },
        fortuneOptions: {
            ...
            career: "Fortune de carrière",
            money: "Fortune financière",
            health: "Fortune de santé",
            relationships: "Fortune relationnelle"
        },
        loadingLoopText: "Appel de votre destin...",
        cardStageTitleTemplate: "Carte {num}",
        cardTouchHint: "Touchez la carte",
        keywordPositive: "Positif",
        keywordCaution: "Attention",
        actionPlanButtonLabel: "Conseil réaliste"
    },
    es: {
        mainTitle: "ASK ANYTHING",
        mainSubtitle: "Haz clic en la carta para comenzar",
        questionDialogTitle: "¿Cómo quieres hacer tu pregunta?",
        directInput: "Entrada directa",
        fortuneSelect: "Selección de fortuna",
        mindQuestion: "Preguntar en la mente",
        customQuestionTitle: "Por favor ingresa tu pregunta directamente",
        questionPlaceholder: "Ej: ¿Puedo tener éxito en mi nuevo trabajo?",
        backButton: "Atrás",
        nextButton: "Siguiente",
        actionPlanButton: "Plan de acción IA",
        mbtiInputTitle: "¿Cuál es tu MBTI?",
        mbtiInputDesc: "Esto proporciona consejos más precisos en tus resultados.",
        mbtiPlaceholder: "Ej: INFP, ENFJ",
        skipButton: "Omitir",
        mbtiUnknownButton: "¿No conoces tu MBTI? Haz la prueba",
        mbtiResultTitle: "Tu MBTI 'Yin-Yang' es...",
        mbtiResultDesc: "Una letra mayúscula significa tendencia fuerte, una letra minúscula significa tendencia débil. Tu lectura de tarot se basará en esto.",
        answerScale: { 
            agree_strong: "Totalmente de acuerdo", 
            agree: "Bastante de acuerdo", 
            neutral: "Neutral / No sé", 
            disagree: "Bastante en desacuerdo", 
            disagree_strong: "Totalmente en desacuerdo" 
        },
        selectCards: "Selecciona 4 cartas.",
        interpreting: "Interpretando...",
        individualCardsTitle: "Interpretaciones de cartas individuales",
        prevButton: "Anterior",
        pdfSaveButton: "Guardar como PDF",
        restartButton: "Empezar de nuevo",
        shuffleStatus: {
            playing: "Barajando cartas...",
            completed: "¡Barajado completado!"
        },
        fortuneOptions: {
            ...
            career: "Fortuna profesional",
            money: "Fortuna financiera",
            health: "Fortuna de salud",
            relationships: "Fortuna relacional"
        },
        loadingLoopText: "Llamando a tu destino...",
        cardStageTitleTemplate: "Carta {num}",
        cardTouchHint: "Toca la carta",
        keywordPositive: "Positivo",
        keywordCaution: "Precaución",
        actionPlanButtonLabel: "Consejo realista"
    },
    hin: {
        mainTitle: "ASK ANYTHING",
        mainSubtitle: "कार्ड पर क्लिक करके शुरू करें",
        questionDialogTitle: "आप अपना प्रश्न कैसे पूछना चाहते हैं?",
        directInput: "सीधा इनपुट",
        fortuneSelect: "भाग्य चुनें",
        mindQuestion: "मन में प्रश्न पूछें",
        customQuestionTitle: "कृपया अपना प्रश्न सीधे दर्ज करें",
        questionPlaceholder: "उदाहरण: क्या मैं अपनी नई नौकरी में सफल हो सकूंगा?",
        backButton: "वापस",
        nextButton: "आगे",
        actionPlanButton: "AI कार्य योजना",
        mbtiInputTitle: "आपका MBTI क्या है?",
        mbtiInputDesc: "यह आपके परिणामों में अधिक सटीक सलाह प्रदान करता है।",
        mbtiPlaceholder: "उदाहरण: INFP, ENFJ",
        skipButton: "छोड़ें",
        mbtiUnknownButton: "अपना MBTI नहीं जानते? परीक्षा दें",
        mbtiResultTitle: "आपका 'यिन-यांग MBTI' है...",
        mbtiResultDesc: "एक बड़ा अक्षर मजबूत प्रवृत्ति का मतलब है, और एक छोटा अक्षर कमजोर प्रवृत्ति का मतलब है। आपका टैरो रीडिंग इसके आधार पर किया जाएगा।",
        answerScale: { 
            agree_strong: "पूरी तरह सहमत", 
            agree: "काफी हद तक सहमत", 
            neutral: "तटस्थ / पता नहीं", 
            disagree: "काफी हद तक असहमत", 
            disagree_strong: "पूरी तरह असहमत" 
        },
        selectCards: "4 कार्ड चुनें।",
        interpreting: "व्याख्या कर रहे हैं...",
        individualCardsTitle: "व्यक्तिगत कार्ड व्याख्याएं",
        prevButton: "पिछला",
        pdfSaveButton: "PDF के रूप में सहेजें",
        restartButton: "शुरू से",
        shuffleStatus: {
            playing: "कार्ड फेंट रहे हैं...",
            completed: "फेंटना पूरा!"
        },
        fortuneOptions: {
            general: "सामान्य भाग्य",
            love: "प्रेम भाग्य",
            business: "व्यापार भाग्य",
            marriage: "विवाह भाग्य",
            children: "बच्चों का भाग्य",
            career: "करियर भाग्य",
            money: "धन भाग्य",
...
const MBTI_TEST_DATA = {
    ...
    hin: {
        questions: [
            { text: "कठिन दिन के बाद, दूसरों के साथ बातचीत करना अकेले आराम करने से अधिक प्रभावी है।", score_type: "E" },
            { text: "मुझे अपने विचारों को स्पष्ट करने के लिए किसी और से जोर से बात करने की आवश्यकता है।", score_type: "E" },
            { text: "जब मुझे कुछ नहीं पता होता, तो मैं खुद खोजने के बजाय आस-पास के लोगों से पूछना पसंद करता हूं।", score_type: "E" },
            { text: "मैं विभिन्न लोगों के साथ व्यापक संबंध बनाने का आनंद लेता हूं।", score_type: "E" },
            { text: "अगर मेरी सप्ताहांत की योजनाएं रद्द हो जाती हैं, तो मुझे राहत से अधिक निराशा महसूस होती है।", score_type: "E", killer: true },
            { text: "जब मैं कोई फिल्म देखता या किताब पढ़ता हूं, तो मैं छुपे अर्थों से अधिक ठोस कथानक को महत्वपूर्ण मानता हूं।", score_type: "S" },
            { text: "मैं ऐसी बातचीत का आनंद लेता हूं जो भविष्य की संभावनाओं की कल्पना करती है, जैसे 'अगर... तो क्या होगा?'", score_type: "N" },
            { text: "जब मैं किसी नई जगह पर जाता हूं, तो मैं नक्शा देखने के बजाय अपनी अंतर्ज्ञान का पालन करना पसंद करता हूं।", score_type: "N" },
            { text: "मैं सिद्ध लोकप्रिय स्थानों की सूची का पालन करने के बजाय, बेतरतीब ढंग से खोजे गए रेस्तरां को आजमाना पसंद करता हूं।", score_type: "N" },
            { text: "काम पर, मैं पिछली सफल प्रक्रियाओं का पालन करने के बजाय पूरी तरह से नए दृष्टिकोण के साथ नवाचार करने से अधिक संतुष्टि महसूस करता हूं।", score_type: "N", killer: true },
            { text: "जब कोई दोस्त मुझसे अपनी परेशानी साझा करता है, तो मैं भावनात्मक सांत्वना से पहले तार्किक समाधान प्रदान करना पसंद करता हूं।", score_type: "T" },
            { text: "टीम की एकता के लिए, मैं अपनी बात को छोड़ सकता हूं, भले ही मैं वस्तुनिष्ठ रूप से सही हूं।", score_type: "F" },
            { text: "मुझे 'बहुत ठंडा' कहलाने से अधिक 'तर्कहीन' कहलाने से बुरा लगता है।", score_type: "T" },
            { text: "मैं मानता हूं कि नियम लागू करते समय, सभी पर समान सिद्धांत लागू करना सबसे निष्पक्ष तरीका है।", score_type: "T" },
            { text: "महत्वपूर्ण निर्णय लेते समय, मेरा अंतिम मानदंड 'लोगों की भावनाओं और रिश्तों पर पड़ने वाला प्रभाव' है।", score_type: "F", killer: true },
            { text: "जब मैं यात्रा करता हूं, तो मुझे पहले से विस्तृत योजना बनाकर और पहले से आरक्षण करके ही मन की शांति मिलती है।", score_type: "J" },
            { text: "मैं उस प्रकार का व्यक्ति हूं जो समय सीमा नजदीक आने पर अलौकिक एकाग्रता के साथ काम पूरा करता है।", score_type: "P" },
            { text: "मैं नियुक्ति के लिए विशिष्ट तारीख और समय निर्धारित करना बहुत पसंद करता हूं।", score_type: "J" },
            { text: "मेरे आस-पास का वातावरण (डेस्क, कमरा) अक्सर साफ-सुथरे रूप से व्यवस्थित होने के बजाय व्यवस्थित अराजकता की स्थिति में होता है।", score_type: "P" },
            { text: "अचानक योजना में बदलाव मुझे तनाव के बजाय नए मजे और अवसर के रूप में लगता है।", score_type: "P", killer: true }
        ]
    },
    can: {
        questions: [
            { text: "艱難的一天後，與他人互動比獨自休息更能有效緩解壓力。", score_type: "E" },
            { text: "我需要大聲對別人說出來才能澄清我的想法。", score_type: "E" },
            { text: "當我不知道某事時，我傾向於問附近的人而不是自己搜索。", score_type: "E" },
            { text: "我喜歡與各種各樣的人建立廣泛的關係。", score_type: "E" },
            { text: "如果我的週末計劃被取消，我會感到失望而不是解脫。", score_type: "E", killer: true },
            { text: "看電影或讀書時，我認為具體情節比隱藏意義更重要。", score_type: "S" },
            { text: "我喜歡想像未來可能性的對話，比如'如果...會怎樣？'", score_type: "N" },
            { text: "在一個新地方時，我傾向於跟隨直覺而不是看地圖。", score_type: "N" },
            { text: "我喜歡嘗試隨機發現的餐廳，而不是跟隨經過驗證的熱門地點列表。", score_type: "N" },
            { text: "在工作中，我從完全新穎的方法創新中獲得比遵循過去成功程序更大的滿足感。", score_type: "N", killer: true },
            { text: "當朋友向我傾訴時，我傾向於在情感安慰之前提供邏輯解決方案。", score_type: "T" },
            { text: "為了團隊和諧，即使我客觀上是正確的，我也能讓步。", score_type: "F" },
            { text: "被稱為'不理性'比被稱為'太冷漠'更讓我感到冒犯。", score_type: "T" },
            { text: "我相信在執行規則時，對每個人應用相同原則是公平的。", score_type: "T" },
            { text: "做重要決定時，我的最終標準是'對人們情感和關係的影響'。", score_type: "F", killer: true },
            { text: "旅行時，我只有在提前制定詳細計劃並預訂後才能安心。", score_type: "J" },
            { text: "我是那種在截止日期臨近時以超人專注力完成工作的類型。", score_type: "P" },
            { text: "我喜歡為約會設定具體的日期和時間。", score_type: "J" },
            { text: "我的周圍環境（桌子、房間）經常處於有組織的混亂狀態，而不是整潔排列。", score_type: "P" },
            { text: "突然的計劃變更對我來說更像是新的樂趣和機會，而不是壓力源。", score_type: "P", killer: true }
        ]
    },
    vi: {
        questions: [
            { text: "Sau một ngày khó khăn, tương tác với người khác hiệu quả hơn việc nghỉ ngơi một mình để giảm căng thẳng.", score_type: "E" },
            { text: "Tôi cần nói to với người khác để làm rõ suy nghĩ của mình.", score_type: "E" },
            { text: "Khi tôi không biết điều gì đó, tôi có xu hướng hỏi người xung quanh thay vì tự tìm kiếm.", score_type: "E" },
            { text: "Tôi thích xây dựng mối quan hệ rộng rãi với nhiều người khác nhau.", score_type: "E" },
            { text: "Nếu kế hoạch cuối tuần của tôi bị hủy, tôi cảm thấy thất vọng hơn là nhẹ nhõm.", score_type: "E", killer: true },
            { text: "Khi xem phim hoặc đọc sách, tôi coi cốt truyện cụ thể quan trọng hơn ý nghĩa ẩn.", score_type: "S" },
            { text: "Tôi thích những cuộc trò chuyện tưởng tượng về khả năng tương lai, như 'Nếu... thì sao?'", score_type: "N" },
            { text: "Ở một nơi mới, tôi có xu hướng theo trực giác thay vì xem bản đồ.", score_type: "N" },
            { text: "Tôi thích thử nhà hàng được phát hiện ngẫu nhiên hơn là theo danh sách địa điểm nổi tiếng đã được chứng minh.", score_type: "N" },
            { text: "Trong công việc, tôi cảm thấy hài lòng hơn khi đổi mới với cách tiếp cận hoàn toàn mới thay vì tuân theo các quy trình thành công trước đây.", score_type: "N", killer: true },
            { text: "Khi bạn bè tâm sự với tôi, tôi có xu hướng đưa ra giải pháp logic trước khi an ủi về mặt cảm xúc.", score_type: "T" },
            { text: "Vì sự đoàn kết của nhóm, tôi có thể nhượng bộ ngay cả khi tôi khách quan đúng.", score_type: "F" },
            { text: "Tôi cảm thấy bị xúc phạm hơn khi bị gọi là 'không hợp lý' thay vì 'quá lạnh lùng'.", score_type: "T" },
            { text: "Tôi tin rằng áp dụng cùng nguyên tắc cho mọi người là cách công bằng nhất để thực thi quy tắc.", score_type: "T" },
            { text: "Khi đưa ra quyết định quan trọng, tiêu chí cuối cùng của tôi là 'tác động đến cảm xúc và mối quan hệ của mọi người'.", score_type: "F", killer: true },
            { text: "Khi đi du lịch, tôi chỉ cảm thấy yên tâm sau khi lập kế hoạch chi tiết và đặt chỗ trước.", score_type: "J" },
            { text: "Tôi là kiểu người hoàn thành công việc với sự tập trung siêu phàm khi gần đến hạn chót.", score_type: "P" },
            { text: "Tôi rất thích đặt ngày giờ cụ thể cho cuộc hẹn.", score_type: "J" },
            { text: "Môi trường xung quanh tôi (bàn, phòng) thường ở trạng thái hỗn loạn có tổ chức thay vì được sắp xếp gọn gàng.", score_type: "P" },
            { text: "Thay đổi kế hoạch đột ngột đối với tôi giống như niềm vui và cơ hội mới hơn là nguồn căng thẳng.", score_type: "P", killer: true }
        ]
    },
    id: {
        questions: [
            { text: "Setelah hari yang sulit, berinteraksi dengan orang lain lebih efektif untuk menghilangkan stres daripada beristirahat sendirian.", score_type: "E" },
            { text: "Saya perlu berbicara keras dengan orang lain untuk memperjelas pikiran saya.", score_type: "E" },
            { text: "Ketika saya tidak tahu sesuatu, saya cenderung bertanya kepada orang di sekitar daripada mencari sendiri.", score_type: "E" },
            { text: "Saya menikmati membangun hubungan luas dengan berbagai orang.", score_type: "E" },
            { text: "Jika rencana akhir pekan saya dibatalkan, saya merasa kecewa daripada lega.", score_type: "E", killer: true },
            { text: "Saat menonton film atau membaca buku, saya menganggap alur cerita konkret lebih penting daripada makna tersembunyi.", score_type: "S" },
            { text: "Saya menikmati percakapan yang membayangkan kemungkinan masa depan, seperti 'Bagaimana jika...?'", score_type: "N" },
            { text: "Di tempat baru, saya cenderung mengikuti intuisi daripada melihat peta.", score_type: "N" },
            { text: "Saya lebih suka mencoba restoran yang ditemukan secara acak daripada mengikuti daftar tempat populer yang sudah terbukti.", score_type: "N" },
            { text: "Di tempat kerja, saya merasa lebih puas dengan berinovasi menggunakan pendekatan yang benar-benar baru daripada mengikuti prosedur sukses masa lalu.", score_type: "N", killer: true },
            { text: "Ketika teman curhat kepada saya, saya cenderung menawarkan solusi logis sebelum kenyamanan emosional.", score_type: "T" },
            { text: "Demi harmoni tim, saya bisa mengalah meskipun saya secara objektif benar.", score_type: "F" },
            { text: "Saya lebih tersinggung disebut 'tidak rasional' daripada 'terlalu dingin'.", score_type: "T" },
            { text: "Saya percaya bahwa menerapkan prinsip yang sama untuk semua orang adalah cara yang paling adil untuk menegakkan aturan.", score_type: "T" },
            { text: "Saat membuat keputusan penting, kriteria akhir saya adalah 'dampak pada emosi dan hubungan orang'.", score_type: "F", killer: true },
            { text: "Saat bepergian, saya hanya merasa tenang setelah membuat rencana detail dan memesan terlebih dahulu.", score_type: "J" },
            { text: "Saya tipe orang yang menyelesaikan pekerjaan dengan konsentrasi super saat mendekati tenggat waktu.", score_type: "P" },
            { text: "Saya sangat suka menetapkan tanggal dan waktu spesifik untuk janji temu.", score_type: "J" },
            { text: "Lingkungan sekitar saya (meja, kamar) sering dalam keadaan kekacauan yang terorganisir daripada diatur rapi.", score_type: "P" },
            { text: "Perubahan rencana yang tiba-tiba terasa lebih seperti kesenangan dan peluang baru bagi saya daripada sumber stres.", score_type: "P", killer: true }
        ]
    },
    chn: {
        questions: [
            { text: "艰难的一天后，与他人互动比独自休息更能有效缓解压力。", score_type: "E" },
            { text: "我需要大声对别人说出来才能澄清我的想法。", score_type: "E" },
            { text: "当我不知道某事时，我倾向于问附近的人而不是自己搜索。", score_type: "E" },
            { text: "我喜欢与各种各样的人建立广泛的关系。", score_type: "E" },
            { text: "如果我的周末计划被取消，我会感到失望而不是解脱。", score_type: "E", killer: true },
            { text: "看电影或读书时，我认为具体情节比隐藏意义更重要。", score_type: "S" },
            { text: "我喜欢想象未来可能性的对话，比如'如果...会怎样？'", score_type: "N" },
            { text: "在一个新地方时，我倾向于跟随直觉而不是看地图。", score_type: "N" },
            { text: "我喜欢尝试随机发现的餐厅，而不是跟随经过验证的热门地点列表。", score_type: "N" },
            { text: "在工作中，我从完全新颖的方法创新中获得比遵循过去成功程序更大的满足感。", score_type: "N", killer: true },
            { text: "当朋友向我倾诉时，我倾向于在情感安慰之前提供逻辑解决方案。", score_type: "T" },
            { text: "为了团队和谐，即使我客观上是正确的，我也能让步。", score_type: "F" },
            { text: "被称为'不理性'比被称为'太冷漠'更让我感到冒犯。", score_type: "T" },
            { text: "我相信在执行规则时，对每个人应用相同原则是公平的。", score_type: "T" },
            { text: "做重要决定时，我的最终标准是'对人们情感和关系的影响'。", score_type: "F", killer: true },
            { text: "旅行时，我只有在提前制定详细计划并预订后才能安心。", score_type: "J" },
            { text: "我是那种在截止日期临近时以超人专注力完成工作的类型。", score_type: "P" },
            { text: "我喜欢为约会设定具体的日期和时间。", score_type: "J" },
            { text: "我的周围环境（桌子、房间）经常处于有组织的混乱状态，而不是整洁排列。", score_type: "P" },
            { text: "突然的计划变更对我来说更像是新的乐趣和机会，而不是压力源。", score_type: "P", killer: true }
        ]
    },
    fr: {
        questions: [
            { text: "Après une journée difficile, interagir avec les autres est plus efficace pour soulager le stress que de se reposer seul.", score_type: "E" },
            { text: "J'ai besoin de parler à voix haute avec quelqu'un d'autre pour clarifier mes pensées.", score_type: "E" },
            { text: "Quand je ne sais pas quelque chose, j'ai tendance à demander aux gens autour de moi plutôt que de chercher moi-même.", score_type: "E" },
            { text: "J'aime construire des relations étendues avec diverses personnes.", score_type: "E" },
            { text: "Si mes plans de week-end sont annulés, je me sens plus déçu que soulagé.", score_type: "E", killer: true },
            { text: "En regardant un film ou en lisant un livre, je considère l'intrigue concrète plus importante que les significations cachées.", score_type: "S" },
            { text: "J'aime les conversations qui imaginent les possibilités futures, comme 'Et si...?'", score_type: "N" },
            { text: "Dans un nouvel endroit, j'ai tendance à suivre mon intuition plutôt que de regarder une carte.", score_type: "N" },
            { text: "Je préfère essayer un restaurant découvert au hasard plutôt que de suivre une liste d'endroits populaires éprouvés.", score_type: "N" },
            { text: "Au travail, je ressens plus de satisfaction en innovant avec une approche complètement nouvelle qu'en suivant les procédures réussies du passé.", score_type: "N", killer: true },
            { text: "Quand un ami se confie à moi, j'ai tendance à offrir des solutions logiques avant le réconfort émotionnel.", score_type: "T" },
            { text: "Pour l'harmonie de l'équipe, je peux céder même si j'ai objectivement raison.", score_type: "F" },
            { text: "Je me sens plus offensé d'être appelé 'irrationnel' que 'trop froid'.", score_type: "T" },
            { text: "Je crois qu'appliquer les mêmes principes à tout le monde est la façon la plus équitable d'appliquer les règles.", score_type: "T" },
            { text: "Lors de prises de décisions importantes, mon critère final est 'l'impact sur les émotions et les relations des gens'.", score_type: "F", killer: true },
            { text: "Quand je voyage, je ne me sens à l'aise qu'après avoir établi un plan détaillé et réservé à l'avance.", score_type: "J" },
            { text: "Je suis le type de personne qui termine le travail avec une concentration surhumaine à l'approche de l'échéance.", score_type: "P" },
            { text: "Je préfère beaucoup fixer une date et une heure spécifiques pour un rendez-vous.", score_type: "J" },
            { text: "Mon environnement (bureau, chambre) est souvent dans un état de chaos organisé plutôt que d'être rangé proprement.", score_type: "P" },
            { text: "Un changement de plan soudain me semble plus comme un nouveau plaisir et une opportunité qu'une source de stress.", score_type: "P", killer: true }
        ]
    },
    es: {
        questions: [
            { text: "Después de un día difícil, interactuar con otros es más efectivo para aliviar el estrés que descansar solo.", score_type: "E" },
            { text: "Necesito hablar en voz alta con otra persona para aclarar mis pensamientos.", score_type: "E" },
            { text: "Cuando no sé algo, tiendo a preguntar a las personas cercanas en lugar de buscar yo mismo.", score_type: "E" },
            { text: "Disfruto construyendo relaciones amplias con diversas personas.", score_type: "E" },
            { text: "Si mis planes de fin de semana se cancelan, me siento más decepcionado que aliviado.", score_type: "E", killer: true },
            { text: "Al ver una película o leer un libro, considero la trama concreta más importante que los significados ocultos.", score_type: "S" },
            { text: "Disfruto las conversaciones que imaginan posibilidades futuras, como '¿Qué pasaría si...?'", score_type: "N" },
            { text: "En un lugar nuevo, tiendo a seguir mi intuición en lugar de mirar un mapa.", score_type: "N" },
            { text: "Prefiero probar un restaurante descubierto al azar que seguir una lista de lugares populares probados.", score_type: "N" },
            { text: "En el trabajo, siento más satisfacción innovando con un enfoque completamente nuevo que siguiendo procedimientos exitosos del pasado.", score_type: "N", killer: true },
            { text: "Cuando un amigo se confía en mí, tiendo a ofrecer soluciones lógicas antes que consuelo emocional.", score_type: "T" },
            { text: "Por la armonía del equipo, puedo ceder incluso si objetivamente tengo razón.", score_type: "F" },
            { text: "Me siento más ofendido al ser llamado 'irracional' que 'demasiado frío'.", score_type: "T" },
            { text: "Creo que aplicar los mismos principios a todos es la forma más justa de hacer cumplir las reglas.", score_type: "T" },
            { text: "Al tomar decisiones importantes, mi criterio final es 'el impacto en las emociones y relaciones de las personas'.", score_type: "F", killer: true },
            { text: "Cuando viajo, solo me siento cómodo después de hacer un plan detallado y reservar con anticipación.", score_type: "J" },
            { text: "Soy el tipo de persona que termina el trabajo con concentración sobrehumana cuando se acerca la fecha límite.", score_type: "P" },
            { text: "Prefiero mucho establecer una fecha y hora específicas para una cita.", score_type: "J" },
            { text: "Mi entorno (escritorio, habitación) a menudo está en un estado de caos organizado en lugar de estar ordenado limpiamente.", score_type: "P" },
            { text: "Un cambio de plan repentino se siente más como una nueva diversión y oportunidad para mí que como una fuente de estrés.", score_type: "P", killer: true }
        ]
    }
    // अन्य भाषाएं भी आवश्यकतानुसार जोड़ी जा सकती हैं
};
